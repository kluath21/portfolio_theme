...
<section class="section formation" id="formation">
    <h2 class="formation_title">Résumé de ma Formation de Développeur WordPress chez OpenClassrooms</h2>
    <p class="formation_info">Pour plus de détails, vous pouvez consulter la <strong><a href="<?php echo get_template_directory_uri(); ?>/assets/docs/developpeur-wordpress.pdf" target="_blank">jaquette de la formation</a></strong>.</p>

    <div class="formation_description">
        <div class="formation_card">
            <p><strong>Durée et Modalités :</strong></p>
            <ul>
                <li>Temps plein : 9 mois (600 heures supervisées)</li>
                <li>Total estimé : 1200 heures (600 heures de formation supervisée et 600 heures de formation guidée)</li>
            </ul>
        </div>

        <div class="formation_card">
            <p><strong>Diplôme :</strong></p>
            <p>Niveau 5 (bac+2) - Développeur intégrateur web, reconnu par le Répertoire National des Certifications Professionnelles (RNCP).</p>
        </div>

        <div class="formation_card">
            <p><strong>Objectif :</strong></p>
            <p>Devenir un développeur web front-end spécialisé dans la création et la personnalisation de sites WordPress.</p>
        </div>
        ...
        <div class="formation_card">
            ...
            <ul>
                ...
                <li>Personnalisation de thèmes et plugins</li>
                <li>Optimisation des performances et maintenance</li>
                <li>Gestion de projets web</li>
            </ul>
        </div>

        <div class="formation_card">
            <p><strong>Technologies et Langages :</strong></p>
            <ul>
                <li>WordPress, PHP, HTML, CSS, JavaScript, jQuery, Git & GitHub</li>
                <li>Outils : Elementor, Gutenberg</li>
            </ul>
        </div>

        <div class="formation_card">
            <p><strong>Projets Pratiques :</strong></p>
            <ol>
                <li>Création d'une page web en HTML/CSS (20h)</li>
                <li>Développement d'une page d'accueil pour une agence de voyage (70h)</li>
                <li>Création d'un site complet avec WordPress sans coder (50h)</li>
                <li>Personnalisation d'un thème WordPress avec PHP (70h)</li>
                <li>Optimisation et SEO d'un site WordPress existant (50h)</li>
                <li>Création d'un carrousel en JavaScript (20h)</li>
                <li>Amélioration d'un site avec JavaScript et animations CSS (60h)</li>
                <li>Débogage et tests d'un site WordPress (40h)</li>
                <li>Création d'un site complexe pour une photographe freelance (90h)</li>
                <li>Planification d'un site de e-commerce (60h)</li>
                <li>Déploiement d'un portfolio de développeur (30h)</li>
            </ol>
        </div>

        <div class="formation_card">
            <p><strong>Accompagnement et Mentorat :</strong></p>
            <p>Chaque étudiant est accompagné par un mentor, professionnel du métier, pour surmonter les difficultés et progresser.</p>
        </div>

        <div class="formation_card">
            <p><strong>Opportunités de Carrière :</strong></p>
            <ul>
                <li>Développeur WordPress, Développeur web, Webmaster, Développeur front-end</li>
                <li>Salaire estimé : 34 000€ pour un profil débutant, 53 000€ pour un profil confirmé</li>
            </ul>
        </div>
        ...
        <div class="formation_card">
            ...
            <ul>
                <li>Baccalauréat ou certification de niveau 4</li>
                <li>Expérience professionnelle de 12 mois en numérique</li>
                <li>Test technique en HTML, CSS, JavaScript, PHP, et WordPress</li>
            </ul>
        </div>

        <div class="formation_card">
            <p>Ce parcours de formation m'a permis de développer une expertise complète en WordPress, de gérer des projets web de A à Z et d'être prêt pour intégrer le marché du travail en tant que développeur professionnel.</p>
        </div>
    </div>
</section>
